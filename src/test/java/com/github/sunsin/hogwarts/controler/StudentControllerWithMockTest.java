...
import com.github.sunsin.hogwarts.TestData;
...
import com.github.sunsin.hogwarts.service.StudentService;
...
class StudentControllerWithMockTest {
    ...
    void test_getStudentById_whenIncorrectId() throws Exception {
        Mockito.doThrow(StudentNotFoundException.class).when(studentService).getStudent(anyLong());
